...
resource_group = "demo-ignitemdw-rg"
databricks_workspace = "demo-ignitemdw-dbr3"
...
dbricks_api = f"https://adb-6058854188253685.5.azuredatabricks.net/api/2.0"
azure_ad_user = "rebremer@microsoft.com"

notebookRemote = "/mount_hc_storage" # make sure notebook is uploaded to your workspace in Databricks
databricks_cluster_id = "0406-123107-ycfc0xt9"
...
def run_notebook(dbricks_auth):
    ...
    response = requests.post(f"{dbricks_api}/jobs/create",
        ...
        json={
            ...
            "existing_cluster_id": "0406-123107-ycfc0xt9",
            "notebook_task": {
...
if __name__ == "__main__":
    ...
    # 0.1 Make sure python packages in requirements.txt are installed
    # 0.2 Make sure that user is logged in via CLI
    # 0.3 Make sure that user has workspace in Databricsk
